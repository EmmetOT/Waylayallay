...
public class Pool<T> where T : Component
{
    ...
    /// 
    /// If an object of type T is passed in which was not created by this pool, a log warning will
    /// be printed and no other action will be taken.
    /// 
    ...
    public bool ReturnToPool(T oldItem)
    {
        ...
        if (m_activeList.Contains(oldItem))
        {
        ...
        {
            Debug.LogWarning("Pooler received object not created by pooler.");
